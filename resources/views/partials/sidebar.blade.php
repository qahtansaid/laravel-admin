<div class="left-sidenav">
    ...
    <div class="brand">
        <a href="index" class="logo">
            <span>
                <img src="<?php echo asset('dastone/assets/images/logorsbaru.png');  ?>" alt="logo-small" class="logo-sm">
            </span>
            {{-- <span>
                <img src="<?php //echo asset('dastone/assets/images/logorsbaru.png');  ?>" alt="logo-large" class="logo-lg logo-light">
                <img src="<?php //echo asset('dastone/assets/images/logorsbaru.png');  ?>" alt="logo-large" class="logo-lg logo-dark">
            </span> --}}
        </a>
    </div>
    <!--end logo-->
